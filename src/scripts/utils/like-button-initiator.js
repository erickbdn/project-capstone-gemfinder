...
const LikeButtonInitiator = {
    ...
    async _renderButton() {
      try {
        ...
        const restaurant = await WishlistDestinasiIdb.getDestinasi(id);
    ...
    _renderLikeButtonTemplate() {
      ...
      likeButton.addEventListener('click', async () => {
        await WishlistDestinasiIdb.putDestinasi(this._restaurant);
    ...
    _renderLikedButtonTemplate() {
      ...
      likeButton.addEventListener('click', async () => {
        await WishlistDestinasiIdb.deleteDestinasi(this._restaurant.id);
